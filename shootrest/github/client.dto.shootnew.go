// Code generated by "shoot new -getset -json -file=client.dto.go"; DO NOT EDIT. (v0.3.2-beta.4)
...
// OrgGetter is read-only interface for Org type
...
// OrgSetter is write-only interface for Org type
type OrgSetter interface {
	SetId(int64)
	SetNodeId(string)
	SetLogin(string)
	SetUrl(string)
	...
	SetHooksUrl(string)
	SetIssuesUrl(string)
	SetMembersUrl(string)
	SetPublicMembersUrl(string)
	SetAvatarUrl(string)
...
// ProjectV2Getter is read-only interface for ProjectV2 type
type ProjectV2Getter interface {
	Id() string
	NodeId() string
	Title() string
	Description() string
...
// ProjectV2Setter is write-only interface for ProjectV2 type
...
// RepoGetter is read-only interface for Repo type
...
// RepoSetter is write-only interface for Repo type
